...
android {
    ...
    defaultConfig {
        applicationId = "com.moonwolf125.android.templates.mvvm"
        minSdkVersion(23)
        targetSdkVersion(29)
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(lifecycle("viewmodel", versions.lifecycle))
    implementation(lifecycle("livedata-ktx", versions.lifecycle))
    implementation(lifecycle("extensions", versions.lifecycle))
    implementation(lifecycle("viewmodel-ktx", versions.lifecycle))
...
/**
 * Builds the dependency notation for the named Lifecycle [module] at the given [version].
 *
 * @param module simple name of the Lifecycle module, for example "viewmodel".
 * @param version optional desired version, unspecified if null.
 */
fun DependencyHandler.lifecycle(module: String, version: String): Any = "androidx.lifecycle:lifecycle-$module:$version"
